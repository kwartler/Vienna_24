...
player <- read.csv('https://raw.githubusercontent.com/kwartler/teaching-datasets/main/Miguel%20Castro%20Pitch%20Locations.csv')
...
#Borrowed from CalledStrike package, don't worry about it :)
