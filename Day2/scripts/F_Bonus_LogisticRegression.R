...
# Data
ccData <- read.csv('https://raw.githubusercontent.com/kwartler/teaching-datasets/main/UCI_Credit_Card.csv')
...
# In reality you would partition the prepData as shown previously in a slide
